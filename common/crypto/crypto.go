...
func CreateAddress(b common.Address) common.Address {
	return common.BytesToAddress(Keccak256(b.Bytes())[12:])
}
...
func FromECDSA(priv *ecdsa.PrivateKey) []byte {
	...
	return mathutil.PaddedBigBytes(priv.D, priv.Params().BitSize/8)
}
